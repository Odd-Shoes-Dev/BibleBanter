      ...
      <div className="w-full max-w-md text-center relative z-10 animate-bounce-in">
        ...
        <div className="mb-8">
          <div className="relative inline-block">
            <div
              className="w-24 h-24 rounded-full flex items-center justify-center text-5xl font-black text-white mx-auto mb-4 animate-pulse-glow"
        ...
        <div className="bg-glass-dark rounded-3xl p-5 mb-4">
          ...
          <p className="font-cinzel text-4xl font-black text-white tracking-[0.2em]">
            {pin}
          </p>
        </div>
        ...
        <div className="bg-glass rounded-2xl p-4">
          ...
          <div className="flex flex-wrap gap-2 justify-center">
            {players.slice(0, 12).map((p, i) => (
              ...
              >
                {p.name === playerName ? (
                  <span className="text-amber-300">{p.name} (you)</span>
                ) : (
                  p.name
                )}
              </span>
