    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4"
      ...
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {/* Name */}
          <div>
            <label className="block text-white/50 text-xs font-bold uppercase tracking-wider mb-1.5">Name</label>
          ...
          {/* Confirm Password */}
          <div>
            <label className="block text-white/50 text-xs font-bold uppercase tracking-wider mb-1.5">Confirm Password</label>
            <div className="relative">
